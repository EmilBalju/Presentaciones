...
X tome cualquiera de estos valores es constante $\dfrac{1}{n}$. Esta distribución surge
...
Como la variable aleatoria X tiene distribución uniforme discreta, por defición tenemos que:
...
\begin{center}
2) En la fabricación de un cierto producto se produce con fallas, suponiendo que el numero de fallas sigue la siguiente distribucion uniforme:
\end{center}
$$
f_{X} (x)=\begin{cases}
